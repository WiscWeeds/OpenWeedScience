---
title: "Anova com controle de plantas daninhas"
math: 'true'
date: '2019-12-10'
---
...
O arquivo salvo terá um projeto do R e você deve copiar e colar todos os seus dados (arquivo excel) no mesmo diretório de trabalho criado.
...
O aquivo *dado* possui o controle (control) de caruru com 5 trataments (herbicidas A, B, C, D, E), 2 anos (2013 e 2014) e 3 blocos (rep).
...
```{r}
bartlett.test(control ~ year, data=dado)
```


Os resultados mostram o valor *P*-value = 0,987, a hipótese nula é rejeitada, o que significa que as variações em cada ano são iguais.
...
> Função *Anova* ou função *Anova.glmmTMB* 
